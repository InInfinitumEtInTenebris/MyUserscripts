...
// @version      9.9.4
// @description  Virtualized M3 UI, dynamic theming, full Blocklist/Rule I/O, Multi-Term (|), Gap (---), Filter (#{...}#) operators, Expressive motion, custom CRUD GUI. Smart Priority sorts by length first, then recency/frequency; recent term detection badge. Improved lifecycle. Fixed blocklist scroll, navigation blanking, added error resilience.
// @match        *://*/*
// @grant        GM_getValue
// @grant        GM_setValue
...
(function () {
    ...
    let isNavigating = false; // lock for page transitions
    ...
    function showSettings() {
        ...
        try {
            ...
            // Blocklist section with its own scrollable container
