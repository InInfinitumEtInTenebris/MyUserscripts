...
// @version      10.3.2
// @description  Virtualized M3 UI, dynamic theming, full Blocklist/Rule I/O, Multi-Term (|), Gap (---), Filter (#{...}#) operators, Cross-Element Replacement (Range API), Protected Areas, dark/light theme, operator cheat sheet, unified backup, performance optimisations.
// @match        *://*/*
// @grant        GM_getValue
// @grant        GM_setValue
...
(function () {
    ...
    function isInProtectedArea(node) {
        ...
        if (!el) return false;
        if (el.matches && el.matches(protectedSelectorString)) return true;
        if (el.closest) return !!el.closest(protectedSelectorString);
        return false;
    }
    ...
    function saveProtectedSelectors() {
    ...
    function showSettings() {
        ...
        try {
            ...
            protListContainer.style.maxHeight = '300px';
            ...
            blocklistContainer.style.maxHeight = '300px';
