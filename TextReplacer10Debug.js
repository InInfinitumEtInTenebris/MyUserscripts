// ==UserScript==
// @name         Text Replacer10 (Debug Version)
// @namespace    http://tampermonkey.net/
// @version      3.2.1-mod-debug
// @description  Debug version with logging to help identify errors. Uses Material You styling with text file import/export and case sensitivity.
// @match        *://*/*
// @grant        GM_getValue
// @grant        GM_setValue
// @run-at       document-end
...
(function() {
    ...
    try {
        console.log("Text Replacer Debug: Starting script");
        ...
        function sanitizeReplacements() {
            for (const key in replacements) {
                ...
                if (!rule || typeof rule.newText !== 'string') {
                    console.warn("Corrupted rule for key:", key);
        ...
        console.log("Text Replacer Debug: Script finished initializing");
    } catch (e) {
        console.error("Text Replacer Debug: Error during initialization", e);
    }
})();